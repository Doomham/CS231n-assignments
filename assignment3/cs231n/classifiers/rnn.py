...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        word_vec_in, embed_cache = word_embedding_forward(captions_in, W_embed)
        if self.cell_type == 'rnn':
            h, rnn_cache = rnn_forward(word_vec_in, h0, Wx, Wh, b)
        else:
            h, lstm_cache = lstm_forward(word_vec_in, h0, Wx, Wh, b)
        ...
        dout, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dout, fc_cache)
        if self.cell_type == 'rnn':
